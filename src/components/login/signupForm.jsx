    ...
    return (
        <form className="row align-items-center justify-content-center" noValidate autoComplete="off">
            <div className={`col-12 col-md-5 col-sm-8 ${classes.signupForm}`}>
                <FormInput id="name" placeholder="Name" fn={loginStyles} />
                <FormInput id="email_address" placeholder="Email Address" fn={loginStyles} />
                <FormInput id="password" placeholder="Password" fn={loginStyles} />
                <FormInput id="confirm_password" placeholder="Confirm password" fn={loginStyles} />
